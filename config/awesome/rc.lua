...
local my_clock = wibox.widget.textclock('%a %b %d, %H:%M')
...
--    awful.tag({ "main", "www", "emacs", "terminal", "other" }, s, awful.layout.layouts[2])
...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({ modkey },            "Page_Up",     function () awful.spawn("pamixer -i 1") end,
              {description = "Increase sound", group = "awesome"}),
    awful.key({ modkey },            "Page_Down",     function () awful.spawn("pamixer -d 1") end,
              {description = "Descrease sound", group = "awesome"}),
})
...
awful.keyboard.append_global_keybindings({
    ...
    awful.key {
        ...
        group       = "tag",
        on_press    = function (index)            if client.focus then
                local tag = client.focus.screen.tags[index]
                if tag then
